...
if brand_inp == 'Audi':
    model_inp = col1.selectbox('Enter the Model for the Audi', options=find_model('Audi'))
    model = model_dic[model_inp]  # doing numerical encoding

elif brand_inp == 'Mitsubishi':
    model_inp = col1.selectbox('Enter the model for Misubishi', options=find_model('Mitsubishi'))
    model = model_dic[model_inp] 

elif brand_inp == 'Renault':   
    model_inp = col1.selectbox('Enter the model Renault', options=find_model('Renault'))
    model = model_dic[model_inp]

elif brand_inp == 'Toyota':
    model_inp = col1.selectbox('Enter the model for Toyota', options=find_model('Toyota'))
    model = model_dic[model_inp] 

elif brand_inp == 'BMW':
    model_inp = col1.selectbox('Enter the model for BWM', options=find_model('BMW'))
    model = model_dic[model_inp] 
    
elif brand_inp == 'Mercedes-Benz':
    model_inp = col1.selectbox('Enter the model for Mercedes Benz', options=find_model('Mercedes-Benz'))
    model = model_dic[model_inp] 

elif brand_inp == 'Volkswagen':
    model_inp = col1.selectbox('Enter the model for Volkswagen', options=find_model('Volkswagen'))
    model = model_dic[model_inp] 
